  ...
  return (
    <div
      className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 px-5 py-3
                 bg-white border border-slate-200 rounded-2xl shadow-2xl shadow-black/40
                 backdrop-blur-xl animate-in slide-in-from-bottom-4 duration-300"
      data-testid="bulk-action-bar"
    >
      {/* Selection badge */}
      <div className="flex items-center gap-2 pr-3 border-r border-slate-200">
        <span className="flex items-center justify-center w-6 h-6 rounded-full bg-primary-500 text-slate-900 text-xs font-bold">
          {count}
        </span>
        ...
        <button
          ...
          className="ml-1 text-slate-500 hover:text-slate-900 transition-colors text-lg leading-none"
      ...
      <div className="relative">
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium
                     text-slate-900 bg-slate-50 hover:bg-slate-50 border border-slate-200
        ...
        {showStatusMenu && (
          <div className="absolute bottom-full mb-2 left-0 w-44 bg-white border border-slate-200 rounded-xl shadow-xl overflow-hidden z-10">
      ...
      <div className="relative">
        ...
        {showTagInput && (
          <div className="absolute bottom-full mb-2 left-0 w-64 bg-white border border-slate-200 rounded-xl shadow-xl p-3 z-10">
            <p className="text-xs text-slate-500 mb-2">Comma-separated tags</p>
            <input
              type="text"
              value={tagInput}
            ...
            <button
              ...
              className="mt-2 w-full py-1.5 rounded-lg bg-primary-500 hover:bg-primary-600
                         text-slate-900 text-sm font-medium transition-colors disabled:opacity-40"
            >
              Apply Tags
            </button>
          </div>
      ...
      <button
        ...
        disabled={isPending}
        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium
                   text-danger-400 bg-slate-50 hover:bg-danger-500/10 border border-slate-200
                   transition-colors disabled:opacity-50"
      >
        <span className="text-base">🗑️</span>
        Delete
