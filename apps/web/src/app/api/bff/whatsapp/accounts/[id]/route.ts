// BFF: proxy DELETE /api/v1/whatsapp/accounts/:id and POST sync-templates
...
export async function DELETE(
  ...
  const result = await callApi({ path: `/api/v1/whatsapp/accounts/${id}`, method: 'DELETE', accessToken });
