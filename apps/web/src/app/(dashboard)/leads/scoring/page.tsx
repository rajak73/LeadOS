  ...
  return (
    <div className="space-y-6 h-full flex flex-col">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-slate-900">AI Lead Ranking</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="p-4 bg-white border border-slate-200 rounded-xl flex items-start gap-4 shadow-sm">
          <div className="w-10 h-10 rounded-full bg-primary-500/10 text-primary-500 flex items-center justify-center shrink-0">
            <span className="text-xl">↑</span>
          </div>
          <div>
            <h3 className="font-semibold text-slate-900">Top Scoring Leads</h3>
