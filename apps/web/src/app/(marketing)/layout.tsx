...
export default async function MarketingLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 selection:bg-primary-500/20 font-sans antialiased">
      {/* Sticky Top Navbar */}
      ...
      {/* Footer */}
      <footer className="bg-slate-50 border-t border-slate-200 py-16 mt-32">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            <div className="col-span-2">
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="font-bold tracking-tight text-base text-slate-900">LeadOS</span>
              </div>
